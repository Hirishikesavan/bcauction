...
export const ORGANIZER_STEPS: GuideStep[] = [
  ...
  { id: 'register-players', title: 'Register Players',              body: 'Add players by importing a CSV, or one-by-one with photo, role, category, and base price.', href: '/dashboard/organizer?tab=players', autoCheck: 'hasPlayers' },
  { id: 'sponsor-branding', title: 'Sponsor Branding',               body: 'Upload sponsor logos and banners — they\'ll show on the broadcast screen and generated posters automatically.', href: '/dashboard/organizer?tab=sponsors', autoCheck: 'hasSponsors' },
  ...
  { id: 'broadcast',      title: 'Broadcast Screen',                 body: 'Open the Broadcast Screen on a second device, projector, or OBS browser source — it updates live with every bid, automatically.', href: '/dashboard/organizer?tab=auctions' },
...
export const TEAM_OWNER_STEPS: GuideStep[] = [
  ...
  { id: 'wallet',      title: 'Check Your Wallet',          body: 'Your purse (budget) is shown at the top of your team page — track it closely once bidding starts. Your organizer may also credit a separate Team Wallet for entry-fee refunds or bonuses.', href: '/dashboard/team-owner', autoCheck: 'hasTeam' },
...
export const FEATURE_DOCS: FeatureDoc[] = [
  ...
  { id: 'feat-bulk-import', title: 'Bulk Player Import', body: 'Upload a CSV of players (name, role, category, base price, photo URL) instead of adding them one by one. Available from Players → Bulk Import.', roles: ['organizer'], tags: ['bulk','import','csv','players'] },
  { id: 'feat-team-wallet', title: 'Team Wallet', body: 'A separate balance from the main purse. The organizer can credit or debit it (e.g. refunding an entry fee or awarding a bonus); it does not affect bidding power directly.', roles: ['organizer','team_owner'], tags: ['wallet','credit','debit'] },
  { id: 'feat-broadcast', title: 'Broadcast Screen', body: 'An auto-updating live screen designed for projectors, TVs, or as an OBS Browser Source — shows the current player, bid, and team purses with no manual refresh needed.', roles: ['organizer','viewer'], tags: ['broadcast','obs','screen'] },
  { id: 'feat-sponsors', title: 'Sponsor Ads', body: 'Upload sponsor logos that rotate automatically on the broadcast and audience screens, with an optional click-through website link.', roles: ['organizer'], tags: ['sponsor','ads','logo'] },
  { id: 'feat-branding', title: 'Custom Branding', body: 'Set a league name, tagline, colors, logo, and banner that apply across the auction\'s public-facing pages (audience view, broadcast, posters).', roles: ['organizer'], tags: ['branding','logo','colors'] },
  { id: 'feat-replay', title: 'Auction Replay', body: 'Replay a completed auction\'s bidding history player-by-player, useful for reviewing how the auction unfolded.', roles: ['organizer'], tags: ['replay','history'] },
...
export const FAQS: FaqEntry[] = [
  { id: 'faq-create-auction', question: 'How do I create an auction?', answer: 'Go to My Auctions → Create Auction, fill in the name, date, purse per team, bid increment, and timer, then save.', roles: ['organizer'], tags: ['auction','create','setup'] },
  { id: 'faq-register-players', question: 'How do I add players to my auction?', answer: 'Use Players → Add Player for one at a time, or Bulk Import to upload a CSV of many players at once, including photos.', roles: ['organizer'], tags: ['players','register','csv','import'] },
  ...
  { id: 'faq-sponsor', question: 'How do sponsors get shown?', answer: 'Upload sponsor logos under Sponsors — they rotate automatically on the broadcast and audience screens.', roles: ['organizer'], tags: ['sponsor','branding','logo'] },
